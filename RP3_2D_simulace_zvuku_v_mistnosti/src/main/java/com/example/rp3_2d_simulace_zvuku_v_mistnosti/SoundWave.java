...
public class SoundWave extends Circle {
     ...
     */
    public SoundWave(double x, double y, BaseRoomControllerInterface controller, int radius,  int amplitude) {
...
// Increment the outer radius
    ...
    public void generateWaveDonut() {
        ...
        for (int i = 0; i < numberOfCircles; i++) {
            ...
            // Print the amplitude for the current circle
     ...
     */
    private void setPixelDisplacement(int x, int y, double okamzitaVychylkaValue) {
        ...
        if (gridX >= 0 && gridX < pixelGrid.length && gridY >= 0 && gridY < pixelGrid[0].length) {
            ...
            if (visitedPixels.contains(pixelCoord)) {
                ...
                activePixelCoordinates.add(pixelCoord);
